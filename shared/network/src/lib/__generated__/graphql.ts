...
/**
 * __useGetAnimeCharactersQuery__
 *
 * To run a query within a React component, call `useGetAnimeCharactersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAnimeCharactersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useGetAnimeCharactersQuery(baseOptions?: Apollo.QueryHookOptions<GetAnimeCharactersQuery, GetAnimeCharactersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAnimeCharactersQuery, GetAnimeCharactersQueryVariables>(GetAnimeCharactersDocument, options);
      }
export function useGetAnimeCharactersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAnimeCharactersQuery, GetAnimeCharactersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAnimeCharactersQuery, GetAnimeCharactersQueryVariables>(GetAnimeCharactersDocument, options);
        }
